...
//         async function createData() {
//             await db.collection('suppliers').insertMany([
//                 { name: "Electronics Supplier Inc.", contact: "John Doe", email: "john@electronicsupplier.com" },
//                 { name: "Fashion Supplier Co.", contact: "Jane Smith", email: "jane@fashionsupplier.com" }
//             ]);
...
//             await db.collection('products').insertMany([
//                 { name: "Laptop", category: "Electronics", price: 1000, cost: 800, stock: 50, supplier: "Electronics Supplier Inc." },
//                 { name: "Smartphone", category: "Electronics", price: 800, cost: 600, stock: 40, supplier: "Electronics Supplier Inc." },
//                 { name: "T-shirt", category: "Clothing", price: 20, cost: 10, stock: 100, supplier: "Fashion Supplier Co." },
//                 { name: "Refrigerator", category: "Home Appliances", price: 1200, cost: 1000, stock: 30, supplier: "Electronics Supplier Inc." },
//                 { name: "Shampoo", category: "Beauty & Personal Care", price: 10, cost: 5, stock: 80, supplier: "Fashion Supplier Co." },
//                 { name: "Soccer Ball", category: "Sports & Outdoors", price: 30, cost: 20, stock: 60, supplier: "Fashion Supplier Co." }
//             ]);
